...
public class ImportGOTitan extends ImportGO<DefaultTitanGraph, TitanVertex, VertexLabelMaker, TitanEdge, EdgeLabelMaker> implements Executable {
    ...
    @Override
    protected TitanGoGraph config(String dbFolder, String propertiesFile) {
...
[main/java/com/bio4j/titan/model/go/programs/ImportGOTitan.java]: ImportGOTitan.java.md
