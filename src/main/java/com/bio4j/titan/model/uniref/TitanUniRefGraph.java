		...
		UniRefGraph
{
	...
	public final TitanUniRef90Cluster.TitanUniRef90ClusterType uniRef90ClusterT = new TitanUniRef90Cluster.TitanUniRef90ClusterType(this);
	public TitanKey uniRef100ClusterTkey;
	public TitanKey uniRef100ClusterIdKey;
	public final TitanUniRef100Cluster.TitanUniRef100ClusterType uniRef100ClusterT = new TitanUniRef100Cluster.TitanUniRef100ClusterType(this);


	//------------------INDICES----------------
	//-----------------------------------------
	public TitanNodeIndex.Unique<TitanUniRef50Cluster,TitanUniRef50Cluster.TitanUniRef50ClusterType, TitanUniRef50Cluster.TitanUniRef50ClusterType.id,String> uniRef50ClusterIdIndex;
	public TitanNodeIndex.Unique<TitanUniRef90Cluster,TitanUniRef90Cluster.TitanUniRef90ClusterType, TitanUniRef90Cluster.TitanUniRef90ClusterType.id,String> uniRef90ClusterIdIndex;
	public TitanNodeIndex.Unique<TitanUniRef100Cluster,TitanUniRef100Cluster.TitanUniRef100ClusterType, TitanUniRef100Cluster.TitanUniRef100ClusterType.id,String> uniRef100ClusterIdIndex;
