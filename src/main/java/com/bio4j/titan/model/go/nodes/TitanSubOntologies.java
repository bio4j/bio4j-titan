  ...
  implements SubOntologies
{
  ...
  // MolecularFunction
  // incoming
  public List<? extends MolecularFunction> molecularFunction_in() { return inFromMany( graph().titanMolecularFunctionType()); }
  public List<? extends Term> term_inNodes() { return inFromMany_Nodes( graph().titanMolecularFunctionType()); }
  
  // BiologicalProcess
  // incoming
  public List<? extends BiologicalProcess> biologicalProcess_in() { return inFromMany( graph().titanBiologicalProcessType()); }
  public List<? extends Term> biologicalProcess_inNodes() { return inFromMany_Nodes( graph().titanBiologicalProcessType());}

  // CellularComponent
  // incoming
  public List<? extends CellularComponent> cellularComponent_in() { return inFromMany( graph().titanCellularComponentType()); }
  public List<? extends Term> cellularComponent_inNodes() { return inFromMany_Nodes( graph().titanCellularComponentType()); }
