...
public final class TitanSubOntology
	...
	*/
	...
	public static final class TitanSubOntologyType
		...
		@Override
		public TitanSubOntology.TitanSubOntologyType value() {
			return goGraph.subOntologyT;
		}

		@Override
		public TitanGoTerm.TitanGoTermType sourceType() {
			return goGraph.goTermT;
		}

		@Override
		public TitanSubOntologies.TitanSubOntologiesType targetType() {
