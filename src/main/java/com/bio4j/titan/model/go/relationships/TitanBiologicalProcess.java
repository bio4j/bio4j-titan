 ...
 */
public final class TitanBiologicalProcess extends TitanGoGraph.GoRel <
  Term, Term.Type, TitanTerm, TitanGoGraph.TitanTermType,
  BiologicalProcess, BiologicalProcess.Type, TitanBiologicalProcess, TitanGoGraph.TitanBiologicalProcessType,
  SubOntologies, SubOntologies.Type, TitanSubOntologies, TitanGoGraph.TitanSubOntologiesType
> 
  implements BiologicalProcess
{

  public TitanBiologicalProcess(TitanEdge edge, TitanGoGraph graph) { super(edge, graph); }

  @Override public TitanGoGraph.TitanBiologicalProcessType titanType() { return graph().titanBiologicalProcessType(); }
