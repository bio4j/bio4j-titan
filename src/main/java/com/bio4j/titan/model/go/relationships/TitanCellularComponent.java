 ...
 */
public final class TitanCellularComponent extends TitanGoGraph.GoRel <
  Term, Term.Type, TitanTerm, TitanGoGraph.TitanTermType,
  CellularComponent, CellularComponent.Type, TitanCellularComponent, TitanGoGraph.TitanCellularComponentType,
  SubOntologies, SubOntologies.Type, TitanSubOntologies, TitanGoGraph.TitanSubOntologiesType
> 
  implements CellularComponent
{

  public TitanCellularComponent(TitanEdge edge, TitanGoGraph graph) { super(edge, graph); }

  @Override public TitanGoGraph.TitanCellularComponentType titanType() { return graph().titanCellularComponentType(); }
